...
public class SinglePlayer extends AppCompatActivity {
    ...
    private void putanother()
    {
        if(gameover!=1 && status==1)
        {
            ...
            if(taplocations[z]==2)
            {
                ...
                if(Bsymbol.toString().equals("X")) //if computer's symbol is x
                {
                    if(z==0)
                    {
                ...
                else //if computer's symbol is O
                {
                    if(z==0)
                    {
            ...
            if(gameover==1 && e!=1) //game is over and either the player has won or the computer has won
            {
                if(a==0 || b==0 || c==0 || d==0)
                {
                    winner="You win";
                ...
                Intent goToSingleResult = new Intent (getApplicationContext(),SingleResult.class);
                goToSingleResult.putExtra("winner",winner.toString());
                goToSingleResult.putExtra("Psymbol",Psymbol.toString());
                goToSingleResult.putExtra("Bsymbol",Bsymbol.toString());
                goToSingleResult.putExtra("playerName",playerName.toString());
            ...
            if(e==1)
            {
                ...
                Intent goToSingleResult = new Intent (getApplicationContext(),SingleResult.class);
                goToSingleResult.putExtra("winner","game is a draw");
                goToSingleResult.putExtra("Psymbol",Psymbol.toString());
                goToSingleResult.putExtra("Bsymbol",Bsymbol.toString());
                goToSingleResult.putExtra("playerName",playerName.toString());
                goToSingleResult.putExtra("choice",choice.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent fromSinglePlayerInfo = getIntent();

        playerName = fromSinglePlayerInfo.getStringExtra("playerName");
        playerSymbol= fromSinglePlayerInfo.getStringExtra("playerSymbol");
        choice=fromSinglePlayerInfo.getStringExtra("choice");

        symbolNameText=findViewById(R.id.symbolNameText);
        ...
        if(playerSymbol.toString().equals("x") || playerSymbol.toString().equals("X"))
        {
            Psymbol="X";
            Bsymbol="O";
        }
        ...
        if(ch==1)
        {
            symbolNameText.setText(playerName.toString()+",your symbol is: " +Psymbol.toString()+"\nYou begin");
